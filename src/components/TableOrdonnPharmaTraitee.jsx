...
import {  getOrdonnanceTraitee } from '../services/pharmacyApi';
...
const columns = [
    ...
    { id: "dateTraitement", label: "Date de fin de traitement", minWidth: 200}
];

export default function TableOrdonnPharmaciTraitee() {
  ...
  useEffect(() => {
    async function fetchRequests() {
        try {
            const data = await getOrdonnanceTraitee();
            if (!data || data.error) {
